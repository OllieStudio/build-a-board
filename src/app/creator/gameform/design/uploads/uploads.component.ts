...
export class UploadsComponent {
  ...
  constructor(private _uploadService: UploadService, public dragservice:DragDropService, public creator:CreatorUIService, private gamedataservice:GameDataService){
